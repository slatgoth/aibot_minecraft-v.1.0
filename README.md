...
- Вкладка "Память" — просмотр и редактирование памяти в реальном времени.
...
## Последнее обновление (v1.2.7)
- Добавлена вкладка "Память" в панели (редактирование в реальном времени).
- Бот видит дроп, читает таблички, распознает постройки и избегает их ломать.
- Длинные задачи: сбор дров и фермерство.
- Автоподбор предметов и расширенный радиус сканирования.
